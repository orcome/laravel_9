        ...
        @can('delete', $master)
            <div class="card">
                ...
                <div class="card-footer">
                    <form method="POST" action="{{ route('masters.destroy', $master) }}" accept-charset="UTF-8" onsubmit="return confirm(&quot;{{ __('app.delete_confirm') }}&quot;)" class="del-form float-right" style="display: inline;">
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('masters.update', $master) }}" accept-charset="UTF-8">
                ...
                <div class="card-footer">
                    ...
                    @can('delete', $master)
                        <a href="{{ route('masters.edit', [$master, 'action' => 'delete']) }}" id="del-master-{{ $master->id }}" class="btn btn-danger float-right">{{ __('app.delete') }}</a>
                    @endcan
                </div>
            </form>
        </div>
